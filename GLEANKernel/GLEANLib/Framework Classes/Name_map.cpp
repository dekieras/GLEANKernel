...
class Duplicate_physical_name : public Glean_exception {
public:
...
class Duplicate_psychological_name : public Glean_internal_error {
public:
...
class Duplicate_names : public Glean_internal_error {
public:
...
class Unknown_name : public Glean_internal_error {
public:
