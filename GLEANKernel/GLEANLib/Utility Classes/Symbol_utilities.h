...
Symbol concatenate_to_Symbol(const char * str, int i);
Symbol concatenate_to_Symbol(const Symbol& sym, int i);
Symbol concatenate_to_Symbol(const char * str1, const char * str2, int i);
Symbol concatenate_to_Symbol(const Symbol& sym1, const Symbol& sym2, int i);
Symbol concatenate_to_Symbol(const char * str, const Symbol& sym, int i);
Symbol concatenate_to_Symbol(const Symbol& sym, const char * str, int i);
